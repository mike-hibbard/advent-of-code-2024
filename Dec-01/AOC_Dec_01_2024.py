...
Two puzzles will be made available on each day in the Advent calendar; the second puzzle is
...
Throughout the Chief's office, the historically significant locations are listed not by name but by a
 unique number called the location ID. To make sure they don't miss anything, The Historians split into two groups, 
...
# Use a function to import the data - maybe put into a list first?
...
# Use map to get the absolute values of the diffs
...
diffs = list(map(abs, list_1, list_2))
